...
class HTU21DF: public TemperatureSensor, public HumiditySensor {
    public:
        HTU21DF(
            ...
            _humdSensors(this, measureSamples, expireTime)
        {};
        ...
        bool getTemperature(float *temp, bool forceUpdate = false) {
            return _tempSensor.getValue(temp, forceUpdate);
        };
        bool getHumidity(float *humd, bool forceUpdate = false) {
            return _humdSensors.getValue(humd, forceUpdate);
        };
        bool getHumidityComp(float *humd, bool forceUpdate = false);
        bool getDewPoint(float *dewPoint, bool forceUpdate = false);
    ...
    private:
        ...
        HTU21DFHumdSensor _humdSensors;
};
